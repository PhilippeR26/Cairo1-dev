...
trait IHelloStarknet<TContractState> {
    ...
    fn array_new_types(
        self: @TContractState,
        aca: Array<ContractAddress>,
        aetha: Array<EthAddress>,
        ach: Array<ClassHash>
...
mod HelloStarknet {
    ...
    impl IHelloStarknetImpl of super::IHelloStarknet<ContractState> {
        ...
        fn new_span(self: @ContractState, my_span: Span<u16>) -> Span<u16> {
            // let my_array = (*my_span.snapshot).span();
            let mut my_array: Array<u16> = ArrayTrait::new();
            my_array.append(6_u16);
            my_array.append(7_u16);
